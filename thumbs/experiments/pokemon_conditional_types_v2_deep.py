...
class PokemonExperiment(Experiment):
    ...
    def get_mutable_params(self) -> RangeDict:
        schedule = RangeDict()
        schedule[0, 5500] = MutableHyperParams(
            ...
            dis_weight_decay=0,
            notes="""
V2 looks ok so far but I think I need to have a much wider field of view at the end, aka more layers. Trying 7 stride1 layers after each block, which makes it a little ofer ahalf hte image size at the end.
""",
        )

        schedule[5501, 100000] = MutableHyperParams(
    ...
    def get_params(self) -> HyperParams:
        return HyperParams(
            ...
            name="pkmn_cond_embedding_100dim_5embed-sep_64x8_128-batch_d2-g1_5-hidden_00002lr_3kern",
            img_shape=(128, 128, 3),
